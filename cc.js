...
var body = $response.body.replace(/is_vip":"0"/g, 'is_vip":"1"').replace(/"expire_date":""/g, '"expire_date":"1651248000"').replace(/"paytype":"3"/g, '"paytype":"0"').replace(/"sale_price":"\d"/g, '"sale_price":""').replace(/vip_expire_date":""/g, 'vip_expire_date":"1651248000"').replace(/has_buy":"0"/g, 'has_buy":"1"');
$done({ body });
